...
export default function Currencies() {
  ...
  const selectedBaseCurrencyCode =
    activeBaseCurrency !== null && countryCurrency[activeBaseCurrency]
      ? countryCurrency[activeBaseCurrency][0]
      : null;
  const selectedTargetCurrencyCode =
    activeTargetCurrency !== null && countryCurrency[activeTargetCurrency]
      ? countryCurrency[activeTargetCurrency][0]
      : null;
  ...
  return (
    <>
      <div className="container">
        ...
        {trackRateActive ? (
          <Link
            to={`/${selectedBaseCurrencyCode}/${selectedTargetCurrencyCode}`}
          >
          ...
          <span>
            <TrackRateAnchor
              className="track-rate-disabled"
              disabled
              aria-label="Track rate (disabled)"
            ></TrackRateAnchor>
          </span>
        )}
      </div>
